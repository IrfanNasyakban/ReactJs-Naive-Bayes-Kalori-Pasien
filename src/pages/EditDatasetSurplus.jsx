...
const EditDatasetSurplus = () => {
  ...
  const getDatasetById = async () => {
    try {
      ...
      const token = localStorage.getItem("token");
      const response = await axios.get(
        `http://localhost:5000/dataset-surplus/${id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const updateDataset = async (e) => {
    ...
    try {
      ...
      alert(
        error.response?.data?.msg || "Terjadi kesalahan saat mengupdate dataset"
      );
    } finally {
      setLoading(false);
    }
            ...
            <div className="backdrop-blur-xl bg-white/10 border border-white/20 shadow-2xl rounded-2xl overflow-hidden">
              ...
              <div className="p-8">
                <div className="space-y-6">
                  ...
                  {kriteriaSurplus.map((kriteria, index) => (
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 pt-6">
                    ...
                    >
                      ...
                      <span>
                        {loading ? "Mengupdate..." : "Update Dataset"}
                      </span>
                    </button>
